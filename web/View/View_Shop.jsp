<%-- 
    Document   : View_Shop
    Created on : Nov 14, 2024, 5:04:17 PM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <body>
        <div class="app-container">
            ...
            <div class="grid">
                <div class="shop__information grid__row">
                    <div class="grid__column-4">
                        <%
                            ShopOwner shop = (ShopOwner)request.getAttribute("shop");
                            String shopAddress = (String)request.getAttribute("shopAddress");
                            List<Goods> goodsList = (List<Goods>) request.getAttribute("goodsList");
                        %>
                        <ul class="">
                            <li><i class="icon fa fa-home" aria-hidden="true"></i>
                                 <span class="shop__information-detail"><%= shop.getTenshop() %></span></li>
                            <li><i class="icon fa fa-user" aria-hidden="true"></i>
                                 <span class="shop__information-detail"><%= shop.getTenchushop() %></span></li>
                            <li><i class="icon fa fa-phone" aria-hidden="true"></i>
                                 <span class="shop__information-detail"><%= shop.getSdt()%></span></li>
                        </ul>
                    </div>
                    <ul>
                        <li><i class="icon fa fa-map-marker" aria-hidden="true"></i>
                             <span class="shop__information-detail"><%= shopAddress%></span></li>
                        <li><i class="icon fa fa-shopping-cart" aria-hidden="true"></i>
                            Sản phẩm: <span class="shop__information-detail"><%= goodsList.size() %></span></li>
                    </ul>
                </div>
                <div style="font-size: 2REM; margin-bottom: 5px; color: grey;">MẶT HÀNG CỦA SHOP</div>
